function calcular ()
{
    ...
    //Obtem conteúdo dos campos
    var nome = txtnome.value;
    var enf = rbEnf.checked;
    var apt = rbApt.checked;
    var idade = parseInt(txtidade.value);

    //Verifica se o nome foi preenchido e o tipo de plano selecionado
    if (nome =="" || enf ==false && apt==false)
    {
    ...
    const valor_formatado = valorTotal.toLocaleString('pt-BR',{style:'currency', currency:'BRL'});
